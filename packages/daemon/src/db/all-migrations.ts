// The canonical ordered migration list (001 → 083). SINGLE SOURCE: the daemon boot path
...
/** Ordered 001→083 (068 enforcer decisions, dropped forward by 071; 069/070 W3 launch truth). */
